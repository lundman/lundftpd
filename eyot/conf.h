...
extern char *conf_ircnick;
extern char *conf_ircname;
extern int conf_port;
extern char *conf_passwd;
extern struct irc_server *conf_servers;
extern struct irc_channel *conf_chans;
